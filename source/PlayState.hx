...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		shaggyVoice = isShaggy && [
			...
			'roofs', 'supernovae', 'glitch', 'master', 'cheating', 'unfairness', 'kabunga', 'recursed', 'exploitation', 'crikey'
	...
	public function createBackgroundSprites(bgName:String, revertedBG:Bool):FlxTypedGroup<BGSprite>
	{
		...
		switch (bgName)
		{
			...
			case 'daWorld':
				...
				threedbg3 = new BGSprite('void', -1500, -800, 'backgrounds/porkrind/evil', null, 1, 1, false, true);				threedbg2.active = false;
				...
				case 'crikey':
					switch (curStep)
					{
						case 0:
						    ...
						    sflash.setFormat("Nexa Heavy", 16, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
